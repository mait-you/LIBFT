...
int main(void)
{
	...
	// printf("memcpy :%s\n", (char *)memcpy(det, src, 0));
	// printf("memcpy :%s\n", det);

	// char ft_det[14] = "wiiii";

	// printf("ft_memcpy :%s\n", (char *)ft_memcpy(ft_det, src, 0));
	// printf("ft_memcpy :%s\n", ft_det);
	...
	// printf("%lu\n", strlcpy(det, src, sizeof(det)));
	// printf("%s\n", det);

	// char ft_det[10] = "tt";

	// printf("%lu\n", ft_strlcpy(ft_det, src, sizeof(det)));
	// printf("%s\n", ft_det);
	...
	// char ft_det[14] = "Hello, ";

	// printf("%lu\n", ft_strlcat(ft_det, src, 14));
	// printf("%s\n", ft_det);
